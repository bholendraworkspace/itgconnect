...
export const achievements: Achievement[] = [
  ...
  },
  {
    ...
    employeePhotoUrl: 'https://picsum.photos/seed/107/200/200',
    employeePhotoHint: "woman developer",
    title: 'Built Real-Time Analytics Dashboard',
    description: 'Designed and shipped the live metrics dashboard now used daily by the ops team.',
  ...
  },
  {
    ...
    employeePhotoUrl: 'https://picsum.photos/seed/113/200/200',
    employeePhotoHint: "woman product manager",
    title: 'Shipped Mobile App v2.0',
    description: 'Led the complete redesign of the mobile experience, increasing user engagement by 60%.',
  ...
  },
  {
    ...
    employeePhotoUrl: 'https://picsum.photos/seed/110/200/200',
    employeePhotoHint: "man engineer",
    title: 'Mentored 5 Junior Engineers',
    description: 'Guided new hires through onboarding and first projects, improving team velocity by 30%.',
...
export const specialAnnouncements: SpecialAnnouncement[] = [
  ...
  },
  {
    ...
    employeePhotoUrl: "https://picsum.photos/seed/112/200/200",
    type: 'home',
...
export const ideas: Idea[] = [
  ...
  },
  {
    ...
    employeeName: 'Fatima Al-Hassan',
    employeePhotoUrl: "https://picsum.photos/seed/113/200/200",
    title: 'Internal Learning Library',
    description: 'A shared Notion space where employees can post course recommendations, book summaries, and tutorials.',
    votes: 28,
    votedBy: [],
  ...
  },
  {
    ...
    employeeName: 'Aiko Tanaka',
    employeePhotoUrl: "https://picsum.photos/seed/107/200/200",
    title: 'On-call Rotation Dashboard',
    description: 'A real-time dashboard showing who is on-call, their contacts, and any active incidents.',
    votes: 19,
    votedBy: [],
...
export const recognitions: Recognition[] = [
  {
    ...
    message: 'Great job refactoring the auth service! The code is so much cleaner and the team can ship faster now.',
  ...
  },
  {
    ...
    message: 'Congratulations on exceeding your Q2 target! Incredible perseverance and client relationships.',
    date: subDays(today, 3).toISOString(),
  },
  {
    id: 'rec3',
    fromEmployeeId: '13',
    fromEmployeeName: 'Fatima Al-Hassan',
    toEmployeeId: '7',
    toEmployeeName: 'Aiko Tanaka',
    toEmployeePhotoUrl: "https://picsum.photos/seed/107/200/200",
    message: 'The analytics dashboard you built has transformed how we track product metrics. Amazing work!',
    date: subDays(today, 2).toISOString(),
  },
  {
    id: 'rec4',
    fromEmployeeId: '7',
    fromEmployeeName: 'Aiko Tanaka',
    toEmployeeId: '10',
    toEmployeeName: 'Rahul Patel',
    toEmployeePhotoUrl: "https://picsum.photos/seed/110/200/200",
    message: 'Your mentorship made a huge difference for our new engineers. Thank you for always making time!',
...
export const events: Event[] = [
  ...
  },
  {
    ...
    description: 'Monthly tech talk and knowledge sharing session for all engineers.',
  ...
  },
  {
    ...
    description: 'Cross-team design critique and UX alignment session.',
  ...
  {
    id: 'ev4',
    title: 'Sales Kick-off 2026',
    description: 'Annual sales strategy and target setting with the global sales team.',
    date: new Date(new Date().setDate(new Date().getDate() + 18)).toISOString(),
    location: 'Grand Conference Hall / Zoom',
    organizerId: '3',
    rsvps: ['3', '2', '12'],
  },
]
